...
class inconv(nn.Module):
    ...
    def __init__(self, in_ch, out_ch,width_kernel):
        ...
        self.conv = double_conv(in_ch, out_ch,width_kernel)
...
class UNet(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, depth = 5, n_features_zero = 64, dropout=0, width_kernel=3,batch_norm=True,distance_net=False,threshold=20,bins=15):
        """
        ...
        self.inc = inconv(in_channels,n_features,width_kernel)
        # DOWN
